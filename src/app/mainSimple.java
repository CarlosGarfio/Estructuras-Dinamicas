...
public class mainSimple {
    ...
    public static void main(String[] args) {
        ...
        long l = e4.Suma((Metodos<Integer>) X);
        ...
        System.out.println("Se añadio el 60");
        System.out.println("Se añadio un 30 despues del 30");
        System.out.println("Se añadio un 50 en la posicion 6");
        System.out.println("Se añadio un 30 antes de un 20");
        System.out.println("Se añadio un 1 al principio");
        System.out.println("Se removio un 10");
        System.out.println("se removio el numero despues de un 20");
        System.out.println("se removieron todos los 30");
        System.out.println("se removio un numero antes del 10");
